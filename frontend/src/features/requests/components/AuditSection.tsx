...
export default function AuditSection({ 
  ...
  if (selectedProfileId && !loading && auditData.length === 0) {
    return (
      <div className="p-12 text-center bg-white rounded-3xl border border-slate-100 shadow-xl animate-in fade-in zoom-in-95 duration-500">
         ...
         <h3 className="text-3xl font-bold text-navy uppercase tracking-tighter mb-4">Sem histórico operacional</h3>
         <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-10 max-w-sm mx-auto leading-relaxed">
           Não detectamos registros de auditoria ou rastreabilidade para este perfil no banco de dados atual.
         </p>
         <button 
           onClick={() => setSelectedProfileId(null)}
           className="px-10 py-5 bg-navy text-white rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-[#002880] transition-all shadow-xl shadow-navy/20 active:scale-95"
         >
