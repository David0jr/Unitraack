  ...
  return (
    <div className="space-y-6">
       <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          <h3 className="font-bold text-navy text-[10px] uppercase tracking-widest mb-6 flex items-center gap-2">
          ...
          <div className="space-y-4">
            {directors.length > 0 ? (
              ...
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest text-center py-4 border border-dashed border-slate-100 rounded-xl">
       ...
       <div className="bg-navy rounded-2xl p-6 text-white shadow-xl shadow-navy/20 relative overflow-hidden">
          ...
          <h3 className="font-bold text-[10px] uppercase tracking-widest mb-4 opacity-50">Logística de Segurança</h3>
          ...
          <div className="p-3 bg-white/10 rounded-xl border border-white/10 text-[10px] font-bold uppercase tracking-widest text-center">
